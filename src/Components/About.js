                ...
                <div className="about-container">
                    ...
                    <div className="about-section2 boxup">
                        <div className="abot-data">
                            ...
                            <p>Techwe specializes in providing Custom IT solutions as per the business requirement. We believe in partnering with our Clients to optimize and enhance the IT infrastructure.</p>
                            <hr />
